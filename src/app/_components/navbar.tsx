import { selectAllClasses, selectAllCourseModulesByClassId, SelectClasses, SelectModule } from "@/db/query";
import {
  SignedIn,
  SignedOut,
  SignInButton,
              ...
              <details>
                ...
                <ul className="ml-4">
                  {modules.map((module: SelectModule) => (
                    <li key={module.id} className="prose-sm hover:text-saltOrange ">
